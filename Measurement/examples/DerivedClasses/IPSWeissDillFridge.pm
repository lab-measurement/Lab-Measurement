...
sub new {
	...
	$self->{LIMITS} = { 'magneticfield' => 17, 'field_intervall_limits' => [0, 10.99, 13.73, 16.48, 17], 'rate_intervall_limits' => [0.660, 0.552, 0.276, 0.138, 0.138]};
...
sub check_magnet {
	...
	if (not ($version =~ /\b(IPS180)/)) {
		Lab::Exception::CorruptParameter->throw( error => "This Instrument driver is supposed to be used ONLY with LS Weiss Dilution Cryostat !\n");
	}
}
