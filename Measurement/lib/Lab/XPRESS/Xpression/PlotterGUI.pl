...
sub names2numbers {
	...
	if ( exists $self->{plot}->{column_names}{$self->{plot}->{'x-axis'}})
		{
		$self->{plot}->{'x-axis'} =  $self->{plot}->{column_names}{$self->{plot}->{'x-axis'}};
		}
	...
	if ( exists $self->{plot}->{column_names}{$self->{plot}->{'z-axis'}})
		{
		$self->{plot}->{'z-axis'} =  $self->{plot}->{column_names}{$self->{plot}->{'z-axis'}};
		}
		
	if ( exists $self->{plot}->{column_names}{$self->{plot}->{'cb-axis'}})
		{
		$self->{plot}->{'cb-axis'} =  $self->{plot}->{column_names}{$self->{plot}->{'cb-axis'}};
		}
