...
The sweep classes provide a high-level interface for measurement
automation. The following script explains the basic use of sweeps. In this
example we use a two-dimensional voltage sweep: The I<master sweep> controls
