...
my $href = {  
  ...
  'WFMPRE' => {
    ...
    'WFID' => {
      '_VALUE' => '"Ch1, DC coupling, 100.0mV/div, 10.00us/div, 10000 points, Sample mode"'
    },
    'XUNIT' => {
      '_VALUE' => '"s"'
    },
