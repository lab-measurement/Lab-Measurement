...
The Lab::... software is divided into three parts. The are built on top of
...
The modules in the C<Lab::Tools> package provide additional support for
writing good measurement scripts. They offer means of writing data and related
meta information to disk, plotting data etc.

This is neither a Perl, nor a VISA/GPIB tutorial. This tutorial only tries
to explain, how to use the Lab::VISA package. Some introduction into VISA
and GPIB terminology is given though. If you feel the need for more
information on Perl or VISA/GPIB, see the L</References> section[1-6].
...
is created that is connected to one certain instrument. We use the C<-\>id>
method that returns the instrument's id string again.
...
serve as well as all other home grown solutions using LabView or whatever.
    ...
    - most important: Meta data
    - reusability of scripts (not perfect yet)
