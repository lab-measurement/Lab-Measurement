...
The currently most-used interface consting of Lab::Instrument and Lab::XPRESS
modules.

=item *

L</Lab::Moose> is a new interface based on B<Modern Perl> techniques.
It is intendet as a replacement/alternative for the previously mentioned
modules. 
