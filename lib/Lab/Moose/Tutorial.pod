...
=head2 Reading from cache

 my $range = $multimeter->cached_sense_range();


 my $frq = $lia->cached_frq();
...
The instrument initialization requires several additional parameters, which
provide step/rate limits.
