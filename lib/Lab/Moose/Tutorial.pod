...
The documentation of Lab::Measurement can be read on MetaCPAN:

=over

=item * L<Lab::Measurement::Manual>

This is the table of contents referencing all doc pages.

=item * L<Lab::Measurement::Installation>

Howto install Lab::Measurement.

=back

A old tutorial for the historical interfaces
L<Lab::Instrument> and L<Lab::XPRESS> is provided in
L<Lab::Measurement::Tutorial>
