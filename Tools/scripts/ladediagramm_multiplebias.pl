...
my $filename_base = 'taschensuche_transport';

my $sample        = "S5c (81059)";
my $title         = "Alle drei Quantenpunkte";
my $comment       = <<COMMENT;
Differentielle Leitfähigkeit von 12 nach 10; ; Lüftung an; Ca. 25mK.
...
G01=-0.394 (Yoko01); G03=-0.450 (Yoko02); G13=-0.609 (Knick14); G09=-0.609 (Yoko10); 14 offen, 02,04 auf GND
...
for my $g0 (0,-0.3,-0.15,0.15,0.3,0.5,-0.5) {
    ...
    my $measurement=new Lab::Measurement(
        ...
        description     => $comment."V_{SD,DC}=$g0/1000 V\n",
